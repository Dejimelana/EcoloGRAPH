    ...
    def add_measurement(
        ...
        with self._driver.session(database=self.database) as session:
            ...
            session.run(query, {
                ...
                "unit": unit_value,
                "min_value": getattr(measurement, 'value_min', None) or getattr(measurement, 'min_value', None),
                "max_value": getattr(measurement, 'value_max', None) or getattr(measurement, 'max_value', None),
                "std_error": getattr(measurement, 'std_dev', None) or getattr(measurement, 'std_error', None),
